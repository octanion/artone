...
export interface ApiFinchcolorFinchcolor extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'finchcolor';
    pluralName: 'finchcolors';
    singularName: 'finchcolor';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiLayerLayer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::layer.layer'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    consumption: Schema.Attribute.Decimal & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    packageVolume: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiQuestQuest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    system: Schema.Attribute.Relation<'oneToOne', 'api::system.system'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiQuestfieldQuestfield extends Struct.CollectionTypeSchema {
  collectionName: 'questfields';
  info: {
    displayName: 'questfield';
    pluralName: 'questfields';
    singularName: 'questfield';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    option: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    quests: Schema.Attribute.Relation<'manyToMany', 'api::quest.quest'>;
    relationCollection: Schema.Attribute.Enumeration<['finchcolor']>;
    required: Schema.Attribute.Boolean & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<
      ['number', 'boolean', 'select', 'multiselect', 'relation']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
